# -*- coding: utf-8 -*-
"""
Created on Thu Jul 28 15:59:54 2022
...
sic_mon_s = np.array(box0)
sic_mon_s[sic_mon_s>250] = np.NaN

sic_s0= sic_mon_s.reshape(43,12,332,316)
...
fig = plt.figure(figsize=(11.69,8.27), dpi=500)
...
fig.suptitle('Sea ice concentration trends during 1979-2021',fontsize = 17, fontweight = 'bold', y=0.95)

fig.tight_layout()
plt.savefig('NSIDC_SIC_sh_jan2jun_tr.png', dpi=500, bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.savefig('NSIDC_SIC_sh_jul2dec_tr.png', dpi=500, bbox_inches='tight')
plt.show()
