# -*- coding: utf-8 -*-
"""
Created on Tue Aug  2 15:02:43 2022
...
extra0 = Dataset('C:/Users/PC/Desktop/jhc/g02202/south/seaice_conc_monthly_sh_197812_v04r00.nc')
...
for i in range(len(date)):   
    ncfile_path = 'C:/Users/PC/Desktop/jhc/g02202/south/seaice_conc_monthly_sh_{0}_v04r00.nc'.format(date[i])
...
sic = sic_mon.reshape(34,12,332,316)

# monthly mean

djf_data = np.zeros([34,3,332,316])
...
ax = plt.subplot(2,2,1,projection=ccrs.SouthPolarStereo(central_longitude=0))
...
ax.set_title('Summer (DJF)', fontsize=17)
...
ax = plt.subplot(2,2,2,projection=ccrs.SouthPolarStereo(central_longitude=0))
...
ax.set_title('Autumn (MAM)', fontsize=17)
...
ax = plt.subplot(2,2,3,projection=ccrs.SouthPolarStereo(central_longitude=0))
...
ax.set_title('Winter (JJA)', fontsize=17)
...
ax = plt.subplot(2,2,4,projection=ccrs.SouthPolarStereo(central_longitude=0))
...
ax.set_title('Spring (SON)', fontsize=17)
...
fig.tight_layout()
plt.savefig('NSIDC_SIC_sh_djf2son.png', dpi=500, bbox_inches='tight')
plt.show()
